        ...
        <div class="menu-bar">
            <div class="container">
                <div class="mega-menu">
                    ...
                    <div class="menu-item">
                            <a class="menu-item-head" href="/"><i class="icon-home"></i></a>
                        </div>
                    ...
                    <div class="menu-item">
                            ...
                            <div class="menu-item-con">
                                ...
                                <div class="pad-15">
                                    ...
                                    <div class="pad-15 col-6 ">
                                        <a  href="/products/devoretails/" style="display:block;">
                                            <div class="block-lhc-1   pad-10">
                                                <div class="block-img col-3 no-pad" style="text-align:center;"><img
                                                        style="width:70px;" src="/assets/img/cms.png" /></div>
                                                <div class="block-content col-9 no-pad">
                                                    <div class="block-head col-12 no-pad">Devo Retail <span
                                        ...
                                        <a href="/pages/commingsoon" style="display:block;">
                                            <!-- <div class="block-lhc-1  pad-10">
                                                <div class="block-img col-3 no-pad" style="text-align:center;"><img
                                    ...
                                    <div class="pad-15 col-6 ">
                                        <a href="/products/devocart/" style="display:block;">
                                            <div class="block-lhc-1  pad-10">
                                                <div class="block-img col-3 no-pad" style="text-align:center;"><img
                                                        style="width:70px;" src="/assets/img/cartl.png" /></div>
                                                <div class="block-content col-9 no-pad">
                                                    <div class="block-head col-12 no-pad">Devo Cart</div>
                          ...
                          <div class="menu-divder"></div>
                        <div class="menu-item">
                          <a href="/pages/about-us" class="menu-item-head">About-Us</a>
                            
                        </div>
                        <div class="menu-divder"></div>
                    <div class="menu-item">
                           <a href="/pages/contact-us" class="menu-item-head"> Contact-Us</a>
                          ...
                          <!-- <div class="menu-item">
                            ...
                            <div class="menu-item-con">
                                <div class="pad-15">
                                    ...
                                    <div class="pad-15 col-6 ">
                                        <a href="/pages/coming-soon" style="display:block;">
                                            <div class="block-lhc-1  pad-10">
                                                <div class="block-img col-3 no-pad" style="text-align:center;"><img
                        ...
                        <div class="menu-item">
                            <div class="menu-item-head"> Contact-Us</div>
                            <div class="menu-item-con">
                                <div class="pad-15">
